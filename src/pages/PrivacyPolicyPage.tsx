...
function PrivacyPolicyPage() {
    return (
        <>
            <h1 className="mt-8 mb-3 font-bold text-2xl">Privacy Policy</h1>
            <p>
                At uprev, accessible from https://uprev.vercel.app/, one of our
                ...
                and recorded by uprev and how we use it. If you have additional
                ...
                collect in uprev. This policy is not applicable to any
            ...
            <h2 className="mt-8 mb-3 font-bold text-lg">Consent</h2>
            <p>
            ...
            <h2 className="mt-8 mb-3 font-bold text-lg">Log Files</h2>
            <p>
                uprev follows a standard procedure of using log files. These
            ...
            <p>
                ...
                the advertising partners of uprev. Third-party ad servers or ad
                networks uses technologies like cookies, JavaScript, or Web
                Beacons that are used in their respective advertisements and
                links that appear on uprev, which are sent directly to users'
                ...
                Note that uprev has no access to or control over these cookies
            ...
            <p>
                uprev's Privacy Policy does not apply to other advertisers or
            ...
            <p>
                ...
                activity. uprev does not knowingly collect any Personal
